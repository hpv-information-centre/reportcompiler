...
class RContextGenerator(FragmentContextGenerator):
    ...
    def generate_context(self, doc_var, data, metadata):
        r_code = "library(jsonlite, quietly=TRUE);\
                    ...
                    print(toJSON(generate_context(doc_var, data, metadata), auto_unbox=TRUE))"
        ...
        try:
            ...
            FragmentContextGenerator.raise_generator_exception(metadata['fragment_path'], e, metadata, message=e.stderr)
